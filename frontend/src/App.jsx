...
<h2 className="text-orange-800 font-semibold mb-5">
Loan Information
</h2>
...
<input name="loan_amnt" type="number" className={inputStyle("loan_amnt")} onChange={handleChange} onKeyDown={preventInvalidNumberInput}/>
...
<div className="relative">
<input name="int_rate" type="number" className={inputStyle("int_rate")} onChange={handleChange} onKeyDown={preventInvalidNumberInput}/>
<span className="absolute right-3 top-2 text-gray-400">%</span>
</div>
...
<select name="term" className={inputStyle("term")} onChange={handleChange}>
...
<div className="relative">
<input name="installment" type="number" className={inputStyle("installment")} onChange={handleChange} onKeyDown={preventInvalidNumberInput}/>
...
<h2 className="text-rose-800 font-semibold mb-5">
Borrower Information
</h2>
...
<div className="relative">
<input name="annual_inc" type="number" className={inputStyle("annual_inc")} onChange={handleChange} onKeyDown={preventInvalidNumberInput}/>
<span className="absolute right-3 top-2 text-gray-400">$</span>
</div>
...
<div className="relative">
<input name="emp_length" type="number" className={inputStyle("emp_length")} onChange={handleChange} onKeyDown={preventInvalidNumberInput}/>
...
<select name="home_ownership" className={inputStyle("home_ownership")} onChange={handleChange}>
<option>RENT</option>
...
<select name="verification_status" className={inputStyle("verification_status")} onChange={handleChange}>
...
<h2 className="text-emerald-800 font-semibold mb-5">
Credit Information
</h2>
...
<div className="relative">
<input name="dti" type="number" className={inputStyle("dti")} onChange={handleChange} onKeyDown={preventInvalidNumberInput}/>
<span className="absolute right-3 top-2 text-gray-400">%</span>
</div>
...
<input name="delinq_2yrs" type="number" className={inputStyle("delinq_2yrs")} onChange={handleChange} onKeyDown={preventInvalidNumberInput}/>
...
<input name="inq_last_6mths" type="number" className={inputStyle("inq_last_6mths")} onChange={handleChange} onKeyDown={preventInvalidNumberInput}/>
...
<input name="open_acc" type="number" className={inputStyle("open_acc")} onChange={handleChange} onKeyDown={preventInvalidNumberInput}/>
...
<div className="relative">
<input name="revol_util" type="number" className={inputStyle("revol_util")} onChange={handleChange} onKeyDown={preventInvalidNumberInput}/>
<span className="absolute right-3 top-2 text-gray-400">%</span>
</div>
...
<input name="total_acc" type="number" className={inputStyle("total_acc")} onChange={handleChange} onKeyDown={preventInvalidNumberInput}/>
...
<input name="fico_score" type="number" className={inputStyle("fico_score")} onChange={handleChange} onKeyDown={preventInvalidNumberInput}/>
